...
public interface ChangesDateRepository {
    ...
    @Update("UPDATE changes_date SET entrant_id=#{ChangesDate.entrantId}, " +
            "date_of_creation=#{ChangesDate.dateOfCreation},date_of_send=#{ChangesDate.dateOfSend}," +
            "date_of_answer=#{ChangesDate.dateOfAnswer},rejection_reason=#{ChangesDate.rejectionReason} " +
            "WHERE entrant_id=#{ChangesDate.entrantId}")
