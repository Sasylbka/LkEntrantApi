...
public interface AdditionalInformationRepository {
    ...
    @Update("UPDATE additional_information SET entrant_id=#{additionalInformation.entrantId}, index=#{additionalInformation.index}, " +
            ...
            "number_of_apartments=#{additionalInformation.numberOfApartments},type=#{additionalInformation.type},coincides=#{additionalInformation.coincides} WHERE id=#{additionalInformation.id}")
