...
public interface AdditionalInformationRepository {
    ...
    @Insert("INSERT INTO additional_information(entrant_id, index, region, area, city, street, number_of_building, number_of_apartments,type) " +
            ...
            "#{additionalInformation.numberOfApartments},#{additionalInformation.type})")
    ...
    @Update("UPDATE additional_information SET entrant_id=#{additionalInformation.entrantId}, index=#{additionalInformation.index}, " +
            ...
            "number_of_apartments=#{additionalInformation.numberOfApartments},type=#{additionalInformation.type} WHERE id=#{additionalInformation.entrantId}")
